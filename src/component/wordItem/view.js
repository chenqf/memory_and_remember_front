...
const mapDispatchToProps = dispatch => ({
    //更新级别
    updateLevelHandler:item => dispatch(actions.fetchUpdateLevel(item)),
    //删除当前
    deleteHandler:wordId => dispatch(actions.fetchDeleteItem(wordId)),
    //更新时间
    updateTimeHandler:(item,createTime) => dispatch(actions.fetchUpdateTime(item,createTime)),
});
...
export default class WordItem extends Component{
    ...
    static propTypes = {
        ...
        deleteHandler:PropTypes.func,   // 删除单词
        updateLevelHandler:PropTypes.func, // 更新单词级别
        updateTimeHandler:PropTypes.func, // 更新单词时间级别
